package org.openmrs.module.amrsreporting.web.controller;
...
import org.openmrs.module.amrsreporting.api.utils.ReportRequest;
import org.springframework.web.bind.annotation.RequestMapping;
...
import static org.openmrs.module.amrsreporting.api.db.DatabaseConnector.getConnection;

@Controller
@RequestMapping("/rest/" + RestConstants.VERSION_1 + "/amrsetl")
public class AmrsReportingController extends BaseRestController {
